...
alter table public.decisions
  add constraint fk_decisions_project foreign key (project_id) references public.projects(id) on delete set null;
alter table public.ideas
  add constraint fk_ideas_project foreign key (project_id) references public.projects(id) on delete set null;
alter table public.meetings
  add constraint fk_meetings_project foreign key (project_id) references public.projects(id) on delete set null;
alter table public.documents
  add constraint fk_documents_project foreign key (project_id) references public.projects(id) on delete set null;
